...
**Image version:** 1.0.13

**Source release/branch:** [v0.3.7](https://github.com/devcontainers/images/tree/v0.3.7/src/base-ubuntu)
...
**Digest:** sha256:3cb26c96497bfc785273ed8f2aa6983a68f26138dbf119b4444421d434037700

**Tags:**
```
mcr.microsoft.com/devcontainers/base:1.0.13-jammy
mcr.microsoft.com/devcontainers/base:1.0.13-ubuntu-22.04
mcr.microsoft.com/devcontainers/base:1.0.13-ubuntu22.04
mcr.microsoft.com/devcontainers/base:1.0.13-ubuntu
```
...
**Digest:** sha256:e1631997b524135a594b3e5163d7ea39bb5e1013eacb2a7e194f9eb300387403

**Tags:**
```
mcr.microsoft.com/devcontainers/base:1.0.13-focal
mcr.microsoft.com/devcontainers/base:1.0.13-ubuntu-20.04
mcr.microsoft.com/devcontainers/base:1.0.13-ubuntu20.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
