...
**Image version:** 1.0.14

**Source release/branch:** [v0.3.11](https://github.com/devcontainers/images/tree/v0.3.11/src/base-ubuntu)
...
**Digest:** sha256:58455121a1914fc23fa3440ef505e63776b889b667245c00de3ab3176be07ab7

**Tags:**
```
mcr.microsoft.com/devcontainers/base:1.0.14-jammy
mcr.microsoft.com/devcontainers/base:1.0.14-ubuntu-22.04
mcr.microsoft.com/devcontainers/base:1.0.14-ubuntu22.04
mcr.microsoft.com/devcontainers/base:1.0.14-ubuntu
```
...
**Digest:** sha256:f30c2e838dedc2a670b03f9c9eb9fa8e4f9fda32c2a932b4bbdda204c6f83d65

**Tags:**
```
mcr.microsoft.com/devcontainers/base:1.0.14-focal
mcr.microsoft.com/devcontainers/base:1.0.14-ubuntu-20.04
mcr.microsoft.com/devcontainers/base:1.0.14-ubuntu20.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
