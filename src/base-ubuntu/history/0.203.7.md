...
**Source release/branch:** [v0.2.17](https://github.com/devcontainers/images/tree/v0.2.17/src/base-ubuntu)
...
**Digest:** sha256:b9f3d2f219046300a5f520466831ba93d2432e7a85d653b89da945b8ce168e37

**Tags:**
```
mcr.microsoft.com/devcontainers/base:0.203.7-jammy
mcr.microsoft.com/devcontainers/base:0.203.7-ubuntu-22.04
mcr.microsoft.com/devcontainers/base:0.203.7-ubuntu22.04
```
...
**Digest:** sha256:85df1a70ecf475cef76714b04c4f70ca065c33f63e18ddf78032811f1b0deb0e

**Tags:**
```
mcr.microsoft.com/devcontainers/base:0.203.7-focal
mcr.microsoft.com/devcontainers/base:0.203.7-ubuntu-20.04
mcr.microsoft.com/devcontainers/base:0.203.7-ubuntu20.04
mcr.microsoft.com/devcontainers/base:0.203.7-ubuntu
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:e4b6922b58a0ce2dd9a74d277c531d118e2ab2d2ae39dd54b9c18dd34774e6be

**Tags:**
```
mcr.microsoft.com/devcontainers/base:0.203.7-bionic
mcr.microsoft.com/devcontainers/base:0.203.7-ubuntu-18.04
mcr.microsoft.com/devcontainers/base:0.203.7-ubuntu18.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
