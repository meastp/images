...
DOCKER_MOBY_ARCHIVE_VERSION_CODENAMES="${DOCKERMOBYARCHIVEVERSIONCODENAMES:-"bookworm buster bullseye bionic focal jammy"}"
DOCKER_LICENSED_ARCHIVE_VERSION_CODENAMES="${DOCKERLICENSEDARCHIVEVERSIONCODENAMES:-"bookworm buster bullseye bionic focal hirsute impish jammy"}"
