...
**Source release/branch:** [v0.0.13](https://github.com/devcontainers/images/tree/v0.0.13/src/cpp)
...
**Digest:** sha256:e318c42587b522ff3d8bfa199924fcd9a05711f075d4f3334abaa9defc4d2310

**Tags:**
```
mcr.microsoft.com/devcontainers/cpp:0.205.0-bullseye
mcr.microsoft.com/devcontainers/cpp:0.205.0-debian-11
mcr.microsoft.com/devcontainers/cpp:0.205.0-debian11
mcr.microsoft.com/devcontainers/cpp:0.205.0-debian
mcr.microsoft.com/devcontainers/cpp:0.205.0
```
...
| [vcpkg](https://github.com/microsoft/vcpkg) | 6a29f32abbefd09581e1bd4898db761f8c9cc9cf | /usr/local/vcpkg |
...
**Digest:** sha256:34a3544a2e17766c226aa32980ef5f91060437b78d853aef9b2159feccc28fb2

**Tags:**
```
mcr.microsoft.com/devcontainers/cpp:0.205.0-buster
mcr.microsoft.com/devcontainers/cpp:0.205.0-debian-10
mcr.microsoft.com/devcontainers/cpp:0.205.0-debian10
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:620767e6eebb575b3011a0dcedddf0b4ebb2ebf2d08a60d19b0c28736052d162

**Tags:**
```
mcr.microsoft.com/devcontainers/cpp:0.205.0-jammy
mcr.microsoft.com/devcontainers/cpp:0.205.0-ubuntu-22.04
mcr.microsoft.com/devcontainers/cpp:0.205.0-ubuntu22.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:2c8d1eab726cc8ac88f68ce794c90eca4aa59975542fc71b7012190cf3057308

**Tags:**
```
mcr.microsoft.com/devcontainers/cpp:0.205.0-focal
mcr.microsoft.com/devcontainers/cpp:0.205.0-ubuntu-20.04
mcr.microsoft.com/devcontainers/cpp:0.205.0-ubuntu20.04
mcr.microsoft.com/devcontainers/cpp:0.205.0-ubuntu
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
...
**Digest:** sha256:e6bd9a5d2c8be30ea048d599af170063cb4bc999a5f8f6feb892589b1da0d0ad

**Tags:**
```
mcr.microsoft.com/devcontainers/cpp:0.205.0-bionic
mcr.microsoft.com/devcontainers/cpp:0.205.0-ubuntu-18.04
mcr.microsoft.com/devcontainers/cpp:0.205.0-ubuntu18.04
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
